        ...
        for i in range(n_samples):
            ...
            for j in range(np.random.randint(n_items)+1):
                ...
                if maximum_iou(box, boxes) < 0.3:
                    ...
                    one_hot_label[clIOError: Unable to open file (Unable to open file: name = './backup/partial.model', errno = 2, error message = 'no such file or directory', flags = 0, o_flags = 0)ass_id] = 1
